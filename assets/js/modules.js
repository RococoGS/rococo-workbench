    ...
    <div class="section-grid">
      <div class="card" style="grid-column:1/-1">
        ...
        <div class="recipe-actions">
          <button class="btn soft" data-action="recipe-archive">存入本周食谱</button>
          <button class="btn danger" data-action="recipe-clear">一键清空</button>
        </div>
      </div>
      <div class="card" style="grid-column:1/-1">
...
function renderHealth() {
  ...
  return `
    <div class="section-grid health-grid">
      <div class="card health-card">
        ...
        <div class="ring-wrap">
          ...
          <div class="ring-side">
            ...
            <div class="cal-chip">约消耗 <b>${cal}</b> 千卡</div>
          </div>
        </div>
      </div>
      ...
      <div class="card health-card">
        ...
        <div class="field">
          <div class="row">
            ...
            <button class="btn ${todayWorkout ? "soft" : ""}" data-action="wk-add" style="flex:0 0 auto">${todayWorkout ? "更新打卡" : "今日打卡"}</button>
          </div>
        </div>
        <div class="entry-list health-list">${workoutRows || '<div class="empty">暂无打卡</div>'}</div>
      </div>
      ...
      <div class="card health-card">
        ...
        <div class="entry-list health-list">${weightRows || '<div class="empty">暂无记录</div>'}</div>
      </div>
        ...
        <div class="field">
          <div class="row per-row">
            <div class="per-field">
              ...
              <input class="input" id="perStart" value="${t}" />
            </div>
            <div class="per-field per-days">
              <label class="label">持续天数</label>
              <input class="input" id="perDays" type="number" min="1" value="5" />
            </div>
            <button class="btn soft" data-action="per-add">记录经期</button>
          </div>
        </div>
        <div class="entry-list health-list">${periodRows || '<div class="empty">暂无记录</div>'}</div>
      </div>
    </div>`;
}
